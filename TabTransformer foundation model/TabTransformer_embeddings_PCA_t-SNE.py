...
# Define the TabTransformer model with increased embedding dimensions
...
model = TabTransformer(
    ...
    dim_out=32,  # Output dimension; usually used for classification/regression
...
pca = PCA(n_components=16, random_state=42)  # Reduce to 50 dimensions to retain more variance before t-SNE
...
kmeans = KMeans(n_clusters=5, random_state=42)  # You can change the number of clusters based on your analysis
...
fig.write_html("./synthetic_embeddings_tsne_3D_plot.html")
